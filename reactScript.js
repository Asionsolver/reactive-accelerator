// Simple js way to create an html element
// const p = document.createElement('p');
// p.textContent = 'This is a paragraph';
// document.getElementById("root").appendChild(p);

// React way to create an html element
// const reactElement = React.createElement('div', null, React.createElement('h1', null, 'Hello World!'));

// ReactDOM.createRoot(document.getElementById('root')).render(reactElement);

// JSX way to create an html element
